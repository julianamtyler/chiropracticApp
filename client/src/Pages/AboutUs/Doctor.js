...
const Doctor = () => (
    ...
    <div>
        ...
        <p>
        Dr. Tyler is a board certified by the National Board of Chiropractic Examiners and is an active member of
        the International Academy of Chiropractic Neurology. Dr. Tyler has a gentle approach and specializes in
        Diversified technique, Thompson drop, Activator and Instrument Assisted Soft Tissue. In additional, Dr.
    ...
    <img className="docPic" src={"./assets/diana_tyler_dr.jpg"} alt="Dr. Tyler"/>
    </div>
